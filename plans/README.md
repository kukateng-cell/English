...
| [catalog-teacher-feedback-preview-and-work-items.md](./catalog-teacher-feedback-preview-and-work-items.md) | 實施計劃 | 已完成（production rollout 延後） | 已完成老師簡化意見、正式學生題目預覽、個人待辦／結果通知及 immutable retry，並加固 three-way rebase、stable operation ID、validator parity、待辦聚合、DB guards及feedback pagination |
