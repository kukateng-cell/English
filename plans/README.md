...
| 文件 | 類型 | 狀態 | 說明 |
|---|---|---|---|
| [teacher-learning-reward-index.md](./teacher-learning-reward-index.md) | 實施計劃 | 待審批（Revision 2；兩位 reviewer PASS） | 教師自訂投入／成效權重、每日及期間累積分、完整明細匯出；不設派分或已匯出扣除機制；20/5量尺及目前學年範圍待審閱；功能分支只規劃未實作 |
