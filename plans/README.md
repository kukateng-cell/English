...
| [teacher-workspace-roster-progress-redesign.md](./teacher-workspace-roster-progress-redesign.md) | 重設計計劃 | 進行中 | Revision 3 經兩個獨立相同全範圍review及修訂；正按 phase 實作名冊／進度分家、學生詳情、搜尋／班級篩選／分頁、canonical班級洞察，以及default-false教師級reset capability AND班級scope；不包括 production deploy |
