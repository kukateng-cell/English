...
| [teacher-workspace-roster-progress-redesign.md](./teacher-workspace-roster-progress-redesign.md) | 重設計計劃 | 待審批（定稿；尚未實作） | 兩個獨立相同全範圍review已納入Revision 2；名冊／進度分家、學生詳情、搜尋／班級篩選／分頁、canonical班級洞察，以及default-false教師級reset capability AND班級scope已凍結 |
