...
| 文件 | 類型 | 狀態 | 說明 |
|---|---|---|---|
| [project-consolidation-and-student-handoff.md](./project-consolidation-and-student-handoff.md) | 全項目整頓與交接計劃 | 規劃完成，實施待開始 | 根目錄指引更新、繁體文件、歷史／測試輸出分離、正式詞庫受控搬移、V1 退役及逐批重構；含開發環境說明與驗收矩陣 |
