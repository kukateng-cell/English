...
| [word-catalog-bulk-submission-and-history.md](./word-catalog-bulk-submission-and-history.md) | 實施計劃 | 已完成（本地 implementation／verification） | 200-row preview／compact mutation、批次原子審核、逐詞歷史、provenance-safe 34欄round-trip、proposal-author claim recovery、branch CI integration及catalog browser lifecycle均完成；staging／Vercel及production migration／deploy未執行 |
