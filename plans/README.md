...
| [word-catalog-teacher-workspace-usability-redesign.md](./word-catalog-teacher-workspace-usability-redesign.md) | 重設計計劃 | 待審批（雙重獨立計劃審核PASS） | 將老師完整詞庫改為高密度響應式語義列表，分拆生命週期／待審流程／出題／問題scope，加入完整資料集詞性、A–Z、主題及排序，並以保留列表狀態嘅逐詞歷史drawer取代技術代碼畫面；不改現有審批及資料生命週期 |
