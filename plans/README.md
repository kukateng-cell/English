...
| 文件 | 類型 | 狀態 | 說明 |
|---|---|---|---|
| [study-stream-retention-and-recovery-audit.md](./study-stream-retention-and-recovery-audit.md) | V2 審核修正 | 已完成（第四輪本地及 hosted CI） | 追加 stale-state 只讀重載、terminal 409 outbox 收斂、失效 Objective presentation 退休及 WebKit rotation 時序回歸；17 個 hosted CI jobs 全部成功 |
