...
| [admin-user-directory-and-learning-analytics.md](./admin-user-directory-and-learning-analytics.md) | 實施計劃 | 待審批 | 經兩個獨立全文 reviewer 對同一 frozen revision PASS；重整管理員用戶搜尋／分類／篩選及學生／教師自動重設密碼，擴充教師／管理員日期範圍、班級／學生比較與逐日分析，並以guarded local reset建立多級多班、最多90日繁體示範資料 |
