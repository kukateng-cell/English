...
| 文件 | 類型 | 狀態 | 說明 |
|---|---|---|---|
| [project-consolidation-and-student-handoff.md](./project-consolidation-and-student-handoff.md) | 全項目整頓與交接計劃 | Revision 2 審核跟進完成；實施待開始 | 現行開發主線、P1 獨立交接、P3 existing-DB 回歸、P4 cutover／測試移植矩陣、環境分離及主線治理已補入；文件／目錄整理及 V1 退役尚未實施 |
