...
| [catalog-teacher-feedback-preview-and-work-items.md](./catalog-teacher-feedback-preview-and-work-items.md) | 實施計劃 | 已完成（production rollout 延後） | 老師簡化意見、正式學生題目預覽、個人待辦及 immutable retry 已完成；跨代 conflict metadata、standalone retry applicability、status payload contract 及 checker lineage cleanup 均已加固並通過本地驗證 |
