...
| [catalog-teacher-feedback-preview-and-work-items.md](./catalog-teacher-feedback-preview-and-work-items.md) | 實施計劃 | 已完成（production rollout 延後） | 老師簡化意見、正式學生題目預覽、個人待辦及 immutable retry 已完成；全部 dialog intent freshness、混合批次 NO_CHANGE conflict rebase及老師可讀 blocked row 詳情均已加固並通過本地驗證 |
