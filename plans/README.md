...
| [class-roster-import-and-access-control.md](./class-roster-import-and-access-control.md) | 實施計劃 | 已完成（local verification；production/native gates deferred） | Revision 3 經兩個相同全範圍 reviewer PASS；另見文件內 2026-08-17 學號欄位 compatibility/deprecation note。production-only positive config、完整原生 screen-reader／device matrix仍 deferred |
