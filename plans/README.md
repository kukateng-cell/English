...
| [admin-user-directory-and-learning-analytics.md](./admin-user-directory-and-learning-analytics.md) | 實施計劃 | 進行中 | 經兩個獨立全文 reviewer 對同一 frozen revision PASS；核心本機 admin directory／reset／analytics／繁體 demo fixture 已實作，scale fixture、端到端及裝置／無障礙 QA 仍待補 |
