...
| [catalog-teacher-feedback-preview-and-work-items.md](./catalog-teacher-feedback-preview-and-work-items.md) | 實施計劃 | 已完成（本地驗證） | 補齊老師簡化意見、正式學生題目預覽、個人待辦／結果通知及 rejected／request-resolution 後 immutable 一鍵重新提交閉環；真實教師 UAT／production rollout 延後 |
