...
| 文件 | 類型 | 狀態 | 說明 |
|---|---|---|---|
| [study-stream-retention-and-recovery-audit.md](./study-stream-retention-and-recovery-audit.md) | V2 審核修正 | 已完成（第五輪本地驗證；CI 待確認） | 追加全 action 終結／重播、多筆 outbox drain、跨 scope remediation supersede 及課室共享 IP 容量限流；待推送第五輪提交後核對 hosted CI |
