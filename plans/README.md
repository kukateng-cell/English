...
| [catalog-teacher-feedback-preview-and-work-items.md](./catalog-teacher-feedback-preview-and-work-items.md) | 實施計劃 | 已完成（production rollout 延後） | 老師簡化意見、正式學生題目預覽、個人待辦及 immutable retry 已完成；effective-kind retry、terminal retry chain、feedback target FK、status-only retry UX、建議可見性及穩定 tie ordering 均已加固並通過本地驗證 |
