...
const result = spawnSync(command, args, {
  ...
  env: {
    ...
    PASSWORD_RESET_PRECONDITION_KEY_CURRENT: process.env.PASSWORD_RESET_PRECONDITION_KEY_CURRENT ?? randomBytes(32).toString("base64url"),
    PASSWORD_RESET_PRECONDITION_KEY_CURRENT_ID: process.env.PASSWORD_RESET_PRECONDITION_KEY_CURRENT_ID ?? "e2e-password-reset-v2",
  },
});
