...
export default function LearningRewardPanel({ role, onBack }: { role: Role; onBack: () => void }) {
  ...
  const openTimeline = useCallback(async (studentId: string) => {
    ...
    setExpandedStudentId(studentId); setTimelineLoading(true); setError(null);
    try {
