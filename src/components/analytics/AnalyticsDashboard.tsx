...
export default function AnalyticsDashboard({ role }: { role: Role }) {
  ...
  const [reportMode, setReportMode] = useState<"ANALYTICS" | "REWARD">("ANALYTICS");
  ...
  if (reportMode === "REWARD") return <LearningRewardPanel role={role} onBack={() => setReportMode("ANALYTICS")} />;
