...
const CODE_MESSAGES: Record<string, string> = {
  ...
  REWARD_SCOPE_TOO_LARGE: "學生人數太多，請先按年級或班別篩選後再計算",
  ROSTER_MUTATION_STATE_MISSING: "名單狀態暫時無法核對，請稍後再試",
  ...
  CATALOG_BULK_DISABLED: "批量提交功能目前未啟用",
  CATALOG_HISTORY_DISABLED: "詞庫修改歷史目前未啟用",
  CATALOG_CSV_TOO_LARGE: "檔案超過 4 MiB 上限",
  CATALOG_CSV_TOO_MANY_ROWS: "檔案超過 200 行上限",
  CATALOG_CSV_EMPTY: "檔案沒有資料行",
  CATALOG_CSV_UTF8_INVALID: "CSV 必須使用有效 UTF-8 編碼",
  CATALOG_CSV_HEADER_INVALID: "檔案欄名與 word-catalog-v1 規格不符",
  CATALOG_CSV_HEADER_DUPLICATE: "檔案有重複欄名",
  CATALOG_CSV_QUOTING_INVALID: "CSV 引號格式不正確",
  CATALOG_CSV_COLUMN_COUNT_INVALID: "檔案某行欄數不正確",
  CATALOG_CSV_FORMULA_INVALID: "檔案包含不安全的試算表公式",
  CATALOG_XLSX_INVALID: "Excel（XLSX）檔案格式不正確或包含不支援的內容",
  CATALOG_XLSX_SHEET_INVALID: "Excel（XLSX）檔案必須只有一個名為 Data 的可見工作表",
  CATALOG_FILENAME_INVALID: "檔名編碼不正確",
  CATALOG_CONTENT_TYPE_INVALID: "請上載 Excel（XLSX）或 UTF-8 CSV 檔案",
  CATALOG_EXPORT_FORMAT_INVALID: "匯出格式必須為 XLSX 或 CSV",
  ...
  CATALOG_BATCH_HAS_ERRORS: "批次仍有驗證錯誤，請修正檔案後重新預覽",
  ...
  CATALOG_BATCH_REVIEW_REQUIRED: "批量提交的子項必須由批次審核流程處理",
