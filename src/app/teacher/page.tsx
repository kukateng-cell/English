    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-2xl border border-[#E7EDF8] bg-white p-4 shadow-sm dark:border-[#1E293B] dark:bg-[#111827]">
          ...
          <p className="text-[13px] text-[#7C89A5] dark:text-[#64748B]">学生总数</p>
        </div>
        <div className="rounded-2xl border border-[#E7EDF8] bg-white p-4 shadow-sm dark:border-[#1E293B] dark:bg-[#111827]">
          ...
          <p className="text-[13px] text-[#7C89A5] dark:text-[#64748B]">今日活跃</p>
        </div>
        <div className="rounded-2xl border border-[#E7EDF8] bg-white p-4 shadow-sm dark:border-[#1E293B] dark:bg-[#111827]">
          ...
          <p className="text-[13px] text-[#7C89A5] dark:text-[#64748B]">已掌握词汇</p>
        </div>
        <div className="rounded-2xl border border-[#E7EDF8] bg-white p-4 shadow-sm dark:border-[#1E293B] dark:bg-[#111827]">
          ...
          <p className="text-[13px] text-[#7C89A5] dark:text-[#64748B]">平均进度</p>
        </div>
      </div>
              ...
              <div key={i} className="flex items-center justify-between py-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-[#7C89A5] dark:text-[#64748B]">{s.level} 级</p>
                  </div>
                </div>
